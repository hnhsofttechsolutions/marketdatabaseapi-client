...
class BuyerBrokerPlanController extends Controller
{
    /**
    ...
    {
        $plans = Plan::where('is_type','buyer_broker')->orderBy('id', 'DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
         ...
         $plan->offered_property=0;
         $plan->is_type='buyer_broker';       
        if($plan->save()){
    ...
    {
        $plan = Plan::where('is_type','buyer_broker')->find($id);
